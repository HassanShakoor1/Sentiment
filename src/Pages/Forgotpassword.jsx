...
export default function Forgotpassword() {
  ...
  return (
   ...
   <button onClick={handleNavigate} className='bg-[#062A27] rounded-[30px] h-[45px] mt-5 w-[90%] font-[600] text-[16px] cursor-pointer text-white Satoshi-bold'>Reset Password</button>
