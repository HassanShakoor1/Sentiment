...
export default function Forgotpassword() {
  ...
  return (
   ...
   <img className='w-[13px] h-[25px] ml-1' src={img} />
   </div>
   ...
   <h1 className='font-[1000] text-[24px] text-black mt-5 Satoshi-bold ' >Reset Password</h1>
   ...
   <button onClick={handleResetPassword} className='bg-[#062A27] rounded-[30px] h-[45px] mt-5 w-[90%] font-[600] text-[16px] cursor-pointer text-white Satoshi-bold'>Reset Password</button>
