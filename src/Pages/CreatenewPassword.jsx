...
export default function CreatenewPassword() {
  ...
  return (
   ...
   <h1 className='font-[1000] text-[24px] text-black mt-5 Satoshi-bold ' >Create New Password</h1>
   <h1 className='font-[60] text-[16px] text-black mt-2 ' >Create your new password below.</h1>
 <div className='w-[90%] outline-none border flex items-center border-[#C9C9C9] mt-5 h-[45px] rounded-[5px] '>
 <input className='outline-none border-none w-[90%] p-3 h-[40px]' type={Password ? 'password' : 'text'} name='password' placeholder="New Password"   />
 {Password ? (
 ...
 <div className='w-[90%] outline-none border flex items-center border-[#C9C9C9] mt-5 h-[45px] rounded-[5px] '>
 <input className='outline-none border-none w-[90%] p-3 h-[40px]' type={showPassword ? 'password' : 'text'} name='password' placeholder="Confirm New Password"   />
 {showPassword ? (
   ...
   <button className='bg-[#062A27] rounded-[30px] h-[45px] mt-3 w-[90%] font-[600] text-[16px] cursor-pointer text-white Satoshi-bold'>Continue</button>
   <p className='mt-3  text-[16px] mb-5'> Back to? <Link to="/login" className='font-[600] text-[15px] text-black underline Satoshi-bold'>Log In</Link></p>
    </div>
   <br></br>
   </div>
   </>
