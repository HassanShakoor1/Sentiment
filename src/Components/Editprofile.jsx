...
/>
  ...
  {userProfile?.coverImage  &&<div onClick={handleopenremoveCover} className='  rounded-full w-[20px]  h-[20px] absolute top-2 right-2 flex justify-center items-center text-sm font-[1500] z-20 text-white bg-red-600' ><RiSubtractLine/></div>}
  <label htmlFor="imgcover" className='w-[100%] absolute'>
  {!userProfile?.coverImage &&<div className=' border rounded-full w-[20px] h-[20px] flex justify-center absolute  top-2 right-2 items-center text-sm font-[1500] text-white bg-[#062A27]' >+</div>}
  <input key={key} type="file" name="imgcover" id='imgcover' className='opacity-0 w-[0px] h-[0px]' onChange={handleCoverImageChange} />
</label>
  <img className='rounded-[10px] w-[100%] h-[100%] ' src={userProfile?.coverImage?userProfile?.coverImage:cover}/>
  ...
  {userProfile?.userProfile  &&<div onClick={handleopenremove} className='  rounded-full w-[20px]  h-[20px] absolute top-[3px] right-[14px] flex justify-center items-center text-sm font-[1500] text-white bg-red-600' ><RiSubtractLine/></div>}
  <label htmlFor="img" className='w-[0px] h-[0px] absolute top-1  left-[86px]'>
  {!userProfile?.userProfile &&<div className=' border rounded-full w-[20px] h-[20px] flex justify-center   items-center text-sm font-[1500] text-white bg-[#062A27]' >+</div>}
 
  <input key={key} type="file" name="img" id='img' className='opacity-0 w-[0px] h-[0px]' onChange={handleImageChange}  />

</label>
<img src={userProfile?.userProfile?userProfile?.userProfile :profile1}  className='rounded-full border-[3px] border-[#f0f0f0] w-[120px] h-[120px]' />
  </div>
  </div>
  ...
  <p className='text-[#5F6161] text-[13px] '>{userProfile?.headingText}</p>}
  <h1 className='text-[16px] font-bold mt-1 text-[#062A27]'>{userProfile?.firstName} {userProfile?.lastName}</h1>
  <h1 className='text-[14px] font-bold  mt-1 text-[#062A27]'>{userProfile?.birthDate === "Invalid Date"? "":userProfile?.birthDate} {userProfile?.deathDate === "Invalid Date"? "":"-"} {userProfile?.deathDate === "Invalid Date"? "":userProfile?.deathDate} </h1>
     <p className={`font-bold text-[16px] flex items-center ${userProfile.status === 'Active' ? 'text-[#3F9A55]' : 'text-red-500'}`}><p className='text-[black] font-bold text-[14px] mr-2'>Profile Status:</p> {userProfile.status}</p>
  <div className='w-[100%] flex justify-center items-center mt-3'>
  <button onClick={()=> handleNavigateview(userProfile?.id)}   className='bg-[#062A27] text-[white] rounded-[30px] w-[120px] h-[35px] flex justify-center items-center text-[13px] mr-2'> <img className='w-[18px] mr-2' src={eye}/>Public View</button>
  ...
  <p className='p-3 cursor-pointer text-[#5F6161]' onClick={handleTributes} style={tributes ? { borderBottom: "2px solid black",color:"#062A27" } : {}}>Admins</p>
  </div>
 {timeline &&
<Timeline
toast={toast}
...
<div className='flex justify-between items-center w-[100%]'>
        ...
        <button onClick={handleDelete} className='bg-[#b62335] rounded-[30px] flex border border-[#B08655] justify-center items-center h-[45px] mt-3 w-[48%] font-[500] text-[16px] cursor-pointer text-white'>
        Yes
      </button>
        </div>
      </div>
...
<button onClick={handleUpdateUser}   className='bg-[#062A27] rounded-[30px] flex border border-[#B08655] justify-center items-center h-[45px] mt-5 w-[100%] font-[500] text-[15px] cursor-pointer text-white Satoshi-bold'>Change Profile Type</button>
     </div>
  </div>
    </div>
  </div>
...
<IoClose />
 ...
 <div className='flex justify-center items-center w-[90%] mt-2 flex-col'>
    ...
    <p className='text-center mb-1'>Are you sure you want to change profile picture?</p>
  <div mt={2} className='flex w-[100%] justify-center mt-1'>
    <button  className='border-[#062A27] border text-[#062A27] rounded-[30px] w-[35%] h-[35px] flex justify-center items-center ' onClick={handleCloseshare} >
      No
    </button>
    <button  className='bg-[#062A27] text-[white] rounded-[30px] w-[35%] h-[35px] ml-3  flex justify-center items-center ' onClick={handleFormSubmit}  >
    {btnloader? <div cla><ClipLoader size={20} color="#ffffff" className='mt-2' /></div>: "Yes"}
  </button>
  </div>
  </div>
...
<IoClose />
 ...
 <div className='flex justify-center items-center w-[90%] mt-2 flex-col'>
    ...
    <p className='text-center mb-1'>Are you sure you want to change cover image?</p>
  <div mt={2} className='flex w-[100%] justify-center mt-1'>
    <button  className='border-[#062A27] border text-[#062A27] rounded-[30px] w-[35%] h-[35px] flex justify-center items-center ' onClick={handleCloseshare} >
      No
    </button>
    <button  className='bg-[#062A27] text-[white] rounded-[30px] w-[35%] h-[35px] ml-3  flex justify-center items-center ' onClick={handlecoverupload}  >
    {btnloader? <div cla><ClipLoader size={20} color="#ffffff" className='mt-2' /></div>: "Yes"}
  </button>
  </div>
  </div>
...
>
<div className='flex justify-end w-[90%] mt-3'>
<div onClick={handleopenremove} className='flex justify-center items-center border border-[#E5D6C5] w-[25px] h-[25px] rounded-[50%]'>
<IoClose />
</div>
</div>
 ...
 <div className='flex justify-center items-center w-[90%] mt-2 flex-col'>
    ...
    <p className='text-center mb-1'>Are you sure you want to remove profile picture?</p>
  <div mt={2} className='flex w-[100%] justify-center mt-1'>
    <button  className='border-[#062A27] border text-[#062A27] rounded-[30px] w-[35%] h-[35px] flex justify-center items-center ' onClick={handleopenremove} >
      No
    </button>
    <button  className='bg-[#062A27] text-[white] rounded-[30px] w-[35%] h-[35px] ml-3 flex justify-center items-center ' onClick={handleremoveimg}  >
    {btnloader? <div cla><ClipLoader size={20} color="#ffffff" className='mt-2' /></div>: "Yes"}
  </button>
  </div>
  </div>
...
>
<div className='flex justify-end w-[90%] mt-3'>
<div onClick={handleopenremoveCover} className='flex justify-center items-center border border-[#E5D6C5] w-[25px] h-[25px] rounded-[50%]'>
<IoClose />
</div>
</div>
 ...
 <div className='flex justify-center items-center w-[90%] mt-2 flex-col'>
    ...
    <p className='text-center mb-1'>Are you sure you want to remove cover image?</p>
  <div mt={2} className='flex w-[100%] justify-center mt-1'>
    <button  className='border-[#062A27] border text-[#062A27] rounded-[30px] w-[35%] h-[35px] flex justify-center items-center ' onClick={handleopenremoveCover} >
      No
    </button>
    <button  className='bg-[#062A27] text-[white] rounded-[30px] w-[35%] h-[35px] ml-3 flex justify-center items-center ' onClick={handleremoveCoverimg}  >
    {btnloader? <div cla><ClipLoader size={20} color="#ffffff" className='mt-2' /></div>: "Yes"}
  </button>
  </div>
  </div>
