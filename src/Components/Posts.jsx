  ...
  return (
    <>
      <div className="w-[90%] justify-start items-center flex-col">
        ...
        {tributes.length === 0 && (
          <div className="flex justify-center border border-[#DFE1E1] rounded-[20px] mt-5 items-center flex-col h-[250px] w-[100%]">
            ...
            <p className="text-[#5F6161] text-[13px] w-[70%] text-center mt-3">
              No post has been added yet in collection
            </p>
          </div>
        )}
        {tributes.length >= 1 && (
          <>
            <div className="flex items-center flex-col sm:h-[180px] h-[350px] overflow-y-scroll w-[100%]">
              {tributes?.map((item, index) => (
                <div
                  key={index}
                  className="w-[100%] flex flex-col items-center mt-5"
                >
                  <div className="flex justify-between items-center w-[100%]">
                    <div className="flex items-center">
                      ...
                      />
                      <p className="text-[14px] font-bold Satoshi-bold ml-3 text-[#062A27] whitespace-normal">
                        {truncatedName}
                      </p>
                  ...
                  <div className="w-[100%] flex items-center mb-2">
                    <p className="ml-[50px] font-bold Satoshi-bold text-[14px] text-[#062A27]">
                      {item?.title}
                    </p>
                  </div>

                  <div className="w-[100%] flex items-center">
                    <p className="ml-[50px] text-[#5F6161] ">
                      {item?.description}
                    </p>
                  </div>
                </div>
      ...
      >
        <MenuItem
          onClick={() =>
            handleViewPost(tributes.find((post) => post.id === selectedPostId))
          }
          className="flex items-center"
        >
          <img className="w-[20px] h-[19px] mr-3" src={eye} alt="view" />
          View
        </MenuItem>
        <MenuItem
          onClick={() =>
            handleEditPost(tributes.find((post) => post.id === selectedPostId))
          }
          className="flex items-center"
        >
          <img className="w-[17px] mr-4" src={editb} alt="edit" />
          Edit
        </MenuItem>
        <MenuItem
          onClick={() => {
          ...
          <div className="flex items-center w-[100%] flex-col">
            <div className="flex w-[90%] justify-between items-center mt-5">
              <img
                ...
                alt="back"
              />
              <h1 className="text-[#040A1B] text-[16px] font-bold">
                Add New Post
              </h1>
              <div
                onClick={handleclose}
        ...
        >
          ...
          <div className="flex w-[100%] justify-between items-center flex-col mt-5">
            ...
            <div className="flex w-[90%] justify-start mt-2">
              <p className=" ml-[20px] font-bold Satoshi-bold text-[#062A27]">
                {viewPostDetails?.title}
              </p>
            </div>
            ...
            <div className="flex w-[90%] mt-2 justify-start ">
              <p className="ml-[20px] text-[#5F6161]">
                {viewPostDetails?.description}
              </p>
            </div>
          </div>
          <br />
