          ...
          <div className="w-[100%] justify-start mt-5">
            ...
            >
              <input
                ...
                onChange={(e) =>
                  setUserdata({ ...userdata, veteran: e.target.checked })
                }
        ...
        >
          ...
          <div className="flex justify-start flex-col mt-5">
            ...
            <input
              ...
              className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
              value={userdata?.headingText}
              onChange={(e) =>
                setUserdata({ ...userdata, headingText: e.target.value })
              }
            />
          </div>
          <div className="w-[100%] justify-start mt-5">
            ...
            >
              <input
                ...
                onChange={(e) =>
                  setUserdata({
                    ...userdata,
                    includeHeadline: e.target.checked,
                  })
                }
                style={{ transform: "scale(1.3)" }}
              />
          ...
          <div className="flex justify-start flex-col mt-3">
            ...
            <input
              type="text"
              className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
              value={userdata?.linkObituary}
              onChange={(e) =>
                setUserdata({ ...userdata, linkObituary: e.target.value })
              }
            />
          </div>
          <div className="flex justify-start flex-col mt-3">
            ...
            <textarea
              ...
              value={userdata?.bioInformation}
              onChange={(e) =>
                setUserdata({ ...userdata, bioInformation: e.target.value })
              }
            />
          </div>
          ...
          <div className="flex justify-start flex-col mt-3">
            ...
            <input
              type="date"
              className="w-[100%] outline-none bg-transparent border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
          ...
          <div className="flex justify-start flex-col mt-3">
            ...
            <input
              type="date"
              className="w-[100%] outline-none bg-transparent border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
              value={formatDate(userdata?.deathDate)}
              onChange={(e) =>
                setUserdata({ ...userdata, deathDate: e.target.value })
              }
            />
          </div>
          {bio && (
          ...
          <div className="flex justify-start flex-col mt-3">
            ...
            <select
              className="w-[100%] outline-none border border-[#C9C9C9] h-[35px] rounded-[5px] pl-3 pr-3 text-black"
          ...
          <div className="flex justify-start flex-col mt-3">
            ...
            <input
              type="text"
              className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
              value={userdata?.linkTitle}
              onChange={(e) =>
                setUserdata({ ...userdata, linkTitle: e.target.value })
              }
            />
          </div>
          <div className="flex justify-start flex-col mt-3">
            ...
            <input
              type="text"
              className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
              value={userdata?.linkUrl}
              onChange={(e) =>
                setUserdata({ ...userdata, linkUrl: e.target.value })
              }
            />
          </div>
          <div className="flex justify-start flex-col mt-3">
            ...
            <>
              ...
              <div className="flex justify-start flex-col mt-3">
                ...
                <input
                  type="text"
                  className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
                  value={userdata?.cemeteryName}
                  onChange={(e) =>
                    setUserdata({ ...userdata, cemeteryName: e.target.value })
                  }
                />
              </div>
              <div className="flex justify-start flex-col mt-3">
                ...
                <input
                  type="text"
                  className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
                  value={userdata?.cemeteryPlot}
                  onChange={(e) =>
                    setUserdata({ ...userdata, cemeteryPlot: e.target.value })
                  }
                />
              </div>
              <div className="flex justify-start flex-col mt-3">
                ...
                <input
                  type="text"
                  className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
                  value={userdata?.cemeteryCity}
                  onChange={(e) =>
                    setUserdata({ ...userdata, cemeteryCity: e.target.value })
                  }
                />
              </div>
              <div className="flex justify-start flex-col mt-3">
                ...
                <input
                  type="text"
                  className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
                  value={userdata?.cemeteryState}
                  onChange={(e) =>
                    setUserdata({ ...userdata, cemeteryState: e.target.value })
                  }
                />
              </div>
              <div className="flex justify-start flex-col mt-3">
                ...
                <input
                  type="text"
                  className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
                  value={userdata?.cemeteryLocation}
                  onChange={(e) =>
                    setUserdata({
                      ...userdata,
              ...
              <div className="flex justify-start flex-col mt-3">
                ...
                <input
                  type="text"
                  className="w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3"
                  value={userdata?.donationsUrl}
                  onChange={(e) =>
                    setUserdata({ ...userdata, donationsUrl: e.target.value })
                  }
                />
              </div>
            </>
          ...
          <div className="flex justify-start flex-col mt-3">
            ...
            <textarea
              ...
              value={userdata?.quoteSection}
              onChange={(e) =>
                setUserdata({ ...userdata, quoteSection: e.target.value })
              }
            />
          </div>
          <button
