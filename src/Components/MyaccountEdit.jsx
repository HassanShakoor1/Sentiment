  ...
  return (
    <>
      <div className="flex justify-start  flex-col w-[90%] ">
        <p className="text-[17px] text-[#062A27] Satoshi-bold mt-3">
          Edit Profile
        </p>
        <button
          onClick={handleEventModal}
          className="bg-[#062A27] rounded-[30px] flex border border-[#B08655] justify-center items-center h-[45px] mt-3 w-[100%] font-[500] text-[16px] cursor-pointer text-white Satoshi-bold"
        >
          <IoMdKey className="mr-2 w-[30px] h-[30px]" />
          Change Password
        </button>
            ...
            >
              <RadioGroup
                ...
                onChange={(e) =>
                  setUserdata({
                    ...userdata,
                    muteNotification: e.target.value === "true",
                  })
                }
              >
                <FormControlLabel
                ...
                />
                <h2 className=" mt-2 mb-2 text-[#5F6161]">
                  By selecting this option, you will not receive emails when
                  updating any profile associated with the account.
                </h2>
                <FormControlLabel
                  value="false"
                  control={<Radio style={{ color: "#2F9089" }} />}
                ...
                />
                <h2 className=" mt-2 mb-2 text-[#5F6161]">
                  By selecting this option, you will receive emails when
                  updating any profile associated with the account.
                </h2>
              </RadioGroup>
            </FormControl>
