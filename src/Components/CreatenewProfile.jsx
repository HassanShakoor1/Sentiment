...
export default function CreatenewProfile({ handleback, bio, toast }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await Promise.all([update(newContactRef, updates)]);
      ...
      <div className="flex justify-start  flex-col w-[90%] mt-3">
        ...
        {!bio && (
          <h1 className="mt-2 font-bold text-[15px] text-[#5F6161]">
            Start by entering as much info as you can about your loved one. You
            will have a chance to update this later.
          </h1>
        )}
