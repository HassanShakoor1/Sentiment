...
export default function CreatenewProfile({handleback,bio,toast}) {
  ...
  {!bio &&
   ...
   {!bio && <h1 className='mt-2 font-bold text-[15px] text-[#5F6161]'>Start by entering as much info as you can about your loved one. You will have a chance to update this later.</h1>}
   <div className='flex justify-between items-center w-[100%] mt-5'>
   <div className='flex justify-start flex-col'>
   <label className='mb-2'>First Name *</label>
   <input type='text' placeholder='First Name' className='w-[95%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3' value={firstName} onChange={(e) => setFirstName(e.target.value)}/>
   </div>
   <div className='flex justify-start flex-col'>
   <label className='mb-2'>Last Name *</label>
   <input type='text' placeholder='Last Name' className='w-[95%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3' value={lastName} onChange={(e) => setLastName(e.target.value)} />
   </div>
   </div>
   <div className='flex justify-start flex-col mt-3'>
   <label className='mb-2'>Title</label>
   <input type='text' placeholder='Example Jr - Sr' className='w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3' value={title} onChange={(e) => setTitle(e.target.value)}/>
   <div className='flex justify-center   w-[100%] flex-col mt-3 '>
      ...
      <select id="relationship"  value={relationship} onChange={(e) => setRelationship(e.target.value)}  className='w-[98%] bg-transparent outline-none border-none'>
    ...
    <input ref={fileInputRef} key={key} onChange={handleImageChange} type="file" style={{ display: 'none' }} />
...
>
  ...
  <input type='text' placeholder='In loving memory of' className='w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3' value={headingtext} onChange={(e) => setHeadingtext(e.target.value)}/>
  </div>
  <div className='w-[100%] justify-start mt-5'>
  <span style={{ display: 'flex', alignItems: 'center', width: "100%" }}>
    <input
  ...
  <input type='text' className='w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3' value={linkObituary} onChange={(e) => setLinkObituary(e.target.value)}/>
  </div>
  <div className='flex justify-start flex-col mt-3'>
  <label className='mb-2'>Bio Information:</label>
  <textarea type='text'  className='w-[100%] outline-none border border-[#C9C9C9] min-h-[100px]  h-[35px] rounded-[5px] pl-3 pr-3' value={bioinformation} onChange={(e) => setBioinformation(e.target.value)}/>
  </div>
  <p className='text-[16px] font-bold Satoshi-bold mt-8'>LIFE TIME</p>
  <div className='flex justify-start flex-col mt-3'>
  <label className='mb-2'>Birth Date *</label>
  <input type='date' className='w-[100%] outline-none border border-[#C9C9C9] bg-transparent  h-[35px] rounded-[5px] pl-3 pr-3' value={birthdate} onChange={(e) => setBirthdate(e.target.value)}/>
  </div>
  <div className='flex justify-start flex-col mt-3'>
  <label className='mb-2'>Death Date *</label>
  <input type='date' className='w-[100%] outline-none border border-[#C9C9C9] bg-transparent  h-[35px] rounded-[5px] pl-3 pr-3' value={deathdate} onChange={(e) => setDeathdate(e.target.value)}/>
  </div>
  ...
  <input type='text' className='w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3' value={city} onChange={(e) => setCity(e.target.value)}/>
  </div>
  <div className='flex justify-start flex-col mt-3'>
  ...
  <input type='text' className='w-[100%] outline-none border border-[#C9C9C9]  h-[35px] rounded-[5px] pl-3 pr-3' value={linkUrl} onChange={(e) => setLinkUrl(e.target.value)}/>
  </div>
  <div className='flex justify-start flex-col mt-3'>
    <label className='mb-2'>Link thumbnail:</label>
    <input ref={fileInput} key={key} onChange={handleLinkImage} type="file" style={{ display: 'none' }} />
  ...
  <textarea type='text' placeholder='The way to get started is to quit talking and begin doing. -Walt Disney'  className='w-[100%] outline-none border border-[#C9C9C9] min-h-[100px]  h-[35px] rounded-[5px] pl-3 pt-2 pr-3' value={quotesection} onChange={(e) => setQuotesection(e.target.value)}/>
  </div>
  <button onClick={handleSubmit}  className='bg-[#062A27] rounded-[30px] h-[45px] mt-5 w-[100%] font-[600] text-[16px] cursor-pointer Satoshi-bold text-white'> {btnloader? <div cla><ClipLoader size={20} color="#ffffff" className='mt-2' /></div>: "Save Changes"}</button>
